...
export const SCHEMES = {
  ...
  jewel: {
    ...
    season: 'June – September',
    perM2: 6,
    note: 'Four colour schemes, from cool blues and whites to hot oranges, all edged with the same catmint to tie them together, and sweet peas on oak obelisks for height and scent. Long-flowering perennials, except the sweet peas, which a school or volunteers can grow from seed.',
    plants: [
      { name: "Catmint 'Walker's Low'", latin: 'Nepeta × faassenii', color: '#8e97dc', form: 'spike', h: 0.4, share: 0.16 },
      { name: "Salvia 'Caradonna'", latin: 'Salvia nemorosa', color: '#553a9c', form: 'spike', h: 0.5, share: 0.06 },
      { name: "Agapanthus 'Northern Star'", latin: 'Agapanthus', color: '#3f5fcf', form: 'ball', h: 0.7, share: 0.06 },
      { name: "Cosmos 'Purity'", latin: 'Cosmos bipinnatus', color: '#f8f6ef', form: 'daisy', h: 0.9, share: 0.06 },
      { name: 'Coneflower', latin: 'Echinacea purpurea', color: '#d0569a', form: 'daisy', h: 0.8, share: 0.06 },
      { name: "Phlox 'Bright Eyes'", latin: 'Phlox paniculata', color: '#ee9fcb', form: 'ball', h: 0.8, share: 0.06 },
      { name: "Scabious 'Butterfly Blue'", latin: 'Scabiosa columbaria', color: '#a794dc', form: 'ball', h: 0.5, share: 0.06 },
      { name: "Dahlia 'Bishop of Llandaff'", latin: 'Dahlia', color: '#c01c2c', form: 'cup', h: 0.9, share: 0.06 },
      { name: 'Crimson scabious', latin: 'Knautia macedonica', color: '#8c1d4c', form: 'ball', h: 0.6, share: 0.06 },
      { name: "Penstemon 'Garnet'", latin: 'Penstemon', color: '#a51f45', form: 'spike', h: 0.6, share: 0.06 },
      { name: "Helenium 'Moerheim Beauty'", latin: 'Helenium', color: '#d4611c', form: 'daisy', h: 0.9, share: 0.06 },
      { name: "Rudbeckia 'Goldsturm'", latin: 'Rudbeckia fulgida', color: '#f1b319', form: 'daisy', h: 0.6, share: 0.06 },
      { name: "Crocosmia 'Lucifer'", latin: 'Crocosmia', color: '#dd361b', form: 'spike', h: 0.9, share: 0.06 },
      { name: 'Sweet peas, mixed', latin: 'Lathyrus odoratus', color: '#d88ac4', form: 'cup', h: 1.8, share: 0.12 },
    ],
  },
  perennial: {
...
export const SITES = [
  ...
  },
  {
    ...
    why: [
      ...
      'Planters in the corners frame the square without taking any of the space used for markets and events.',
    ],
    owner: 'North Hertfordshire District Council, to confirm',
    checks: [
      'Nothing goes in the middle of the square: markets, the food festival, the carousel and the summer beach all use it. The planters sit in the corners and on the edges, beside fixed features.',
    ...
    options: [
      ...
      {
        id: 'perennial', name: 'Corner planters, perennials and bulbs', scheme: 'perennial',
  ...
  },
  {
    ...
    why: [
      'The north lawn, between the bandstand and Nightingale Road, is open grass clear of the funfair ground, and everyone walking along Nightingale Road sees it.',
    ...
    checks: [
      ...
      'Keep the west lawn clear: the funfair and events use it.',
      'Keep the beds outside the crowns of the blue cedar and the other lawn trees.',
    ...
    options: [
      {
        ...
        summary: 'Four large flower beds, each framed by a low clipped hedge and planted with roses, delphiniums, foxgloves and lavender, with gravel paths crossing between them to a central sundial and benches. It sits on the north lawn beside the bandstand, clear of the funfair ground, and is approached along a double border beside the path from Nightingale Road. Volunteer teams could each adopt a bed.',
        maintenance: 1, impact: 2, wildlife: 2,
        shapes: [
          { kind: 'parterre', c: [318.4, -652.4], sizeU: 27, sizeV: 20, rot: -50.15 },
          { kind: 'border', pts: [[320.3, -631.2], [336.4, -650.4], [352.4, -669.6]], o0: 0.9, o1: 3.3 },
        ],
      ...
      },
      {
        ...
        summary: 'Just the pair of borders either side of the path from Nightingale Road to the bandstand: low edging at the path and drifts of long-flowering perennials rising to tall verbena at the back. A good first phase for the English garden.',
        maintenance: 1, impact: 1, wildlife: 2,
        shapes: [{ kind: 'border', pts: [[320.3, -631.2], [336.4, -650.4], [352.4, -669.6]], o0: 0.9, o1: 3.6 }],
  ...
  {
    id: 'st-marys',
    name: "St Mary's riverside lawn",
    street: 'St Mary’s Church, by the River Hiz',
    role: 'green',
    headline: 'Four jewel-coloured beds on the lawn between the church and the river.',
    why: [
    ...
    checks: [
      'Confirm who owns and looks after the lawn, and get permission; keep clear of any memorials.',
      'Keep the beds outside the crowns of the copper beech and the riverside trees.',
      'Check whether the lawn is used for events that need the open grass.',
    ],
    partners: ["St Mary's Church", 'Local school (sweet peas from seed)', 'Community planting day'],
    options: [
      {
